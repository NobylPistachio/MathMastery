...
def primeFactorization(n:int, prime_factors = []):
...
def leastCommonDivisibility(a:int,b:int):
    ...
    #         common = b_primeFactors.index(a_primeFactors[element])
            # lcd_factors.append(a_f[eles])
            #a_f.pop(eles),b_f.pop(common)
    #return lcd_factors
# print(isPrime(661))
# leastCommonDivisibility(12,20)
print(primeFactorization(50))